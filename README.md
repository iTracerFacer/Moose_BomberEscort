...
DCS AI NOTE: At the time of this writing, some of the behavior described in this document is intended behavior. More often then not DCS AI will override certain paramaters when there is a bombing waypoit in the route. You might give it 3 waypoints and it may ignore them. Don't be surpirsed if the bombers do something unexpected. I've spent countless hours attempting to influence the routes and behaviours of the AI and have simply reached a stalement as to what is possible. A prime example is the the 2 pass bombing routine the bombers do. You give the bombers a target, they fly over once, come around and drop on a 2nd pass (most of the time). There is simply nothing you can do about this behavior from all of my testing and experimentation. I've lost countless hours of sleep trying to get around it. 
